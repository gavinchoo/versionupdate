...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mReachedBarColor = attributes.getColor(R.styleable.XUpdate_ProgressBar_progress_reached_color, defaultReachedColor);
        int defaultUnreachedColor = Color.rgb(204, 204, 204);
        mUnreachedBarColor = attributes.getColor(R.styleable.XUpdate_ProgressBar_progress_unreached_color, defaultUnreachedColor);
        int defaultTextColor = Color.rgb(66, 145, 241);
        mTextColor = attributes.getColor(R.styleable.XUpdate_ProgressBar_progress_text_color, defaultTextColor);
        mTextSize = attributes.getDimension(R.styleable.XUpdate_ProgressBar_progress_text_size, defaultTextSize);

        mReachedBarHeight = attributes.getDimension(R.styleable.XUpdate_ProgressBar_progress_reached_bar_height, defaultReachedBarHeight);
        mUnreachedBarHeight = attributes.getDimension(R.styleable.XUpdate_ProgressBar_progress_unreached_bar_height, defaultUnreachedBarHeight);
        mOffset = attributes.getDimension(R.styleable.XUpdate_ProgressBar_progress_text_offset, defaultProgressTextOffset);
